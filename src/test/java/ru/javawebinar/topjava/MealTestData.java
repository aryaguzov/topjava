...
public class MealTestData {
    ...
    public static final TestMatcher<MealTo> MEAL_MATCHER_TO = TestMatcher.usingIgnoringFieldsComparator(MealTo.class, "user");
    ...
    public static final List<MealTo> mealsTo = MealsUtil.getTos(List.of(meal3, meal2, meal1), MealsUtil.DEFAULT_CALORIES_PER_DAY);
